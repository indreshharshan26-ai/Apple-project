  ...
  return (
    <>
      ...
      <div className="bg-[#1D1D1F] p-4 text-white ">
             <p className="text-center text-[7px] md:text-[14px] flex items-center justify-center">Get up to ₹10000 instant cashback on your favourite products with eligible cards.◊ Plus up to 6 months of No Cost EMI.‡ <a href="" className="text-blue-600 hover:underline flex items-center justify-center "> Shop <FaChevronRight className="w-3 h-3"/></a></p>
      </div>
...
// var navData=["Store", "Mac", "iPad", "iPhone", "Watch", "AirPods","TV & Home", "Entertainment", "Acessories","Support"]
...
//           <div className=" flex items-center justify-center space-x-10 p-3 bg-[#000000] text-[#A0A0A0]">
//             <h1 className="text-xl"><FaApple/></h1>
//             <ul className="flex items-center justify-center space-x-8 text-xs font-semibold overflow-hidden">
//                 {navData.map((data,index)=>(
//                     <li key={index}><a href="#">{data}</a></li>
//                 ))}
//             </ul>
//             <h1 className="text-[14px]"><FaSearch/></h1>
//             <h1 className="text-[14px]"><FaShoppingBag/></h1>
//             <h1 className="text-[14px] hidden"><FiMenu/></h1>
//           </div>
//           <div className="bg-[#1D1D1F] p-4 text-white ">
